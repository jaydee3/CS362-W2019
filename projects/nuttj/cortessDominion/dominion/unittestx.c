...
int _isGameOver(struct gameState *state);
...
int main()
{
	...
	result = _isGameOver(&S); //should return 0 to indicate game is not over
	...
	result = _isGameOver(&G); //should return 1 to indicate game is over
